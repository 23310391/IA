...
es una técnica que combina la profundidad limitada con la búsqueda en profundidad. 
En IDS, se realiza una serie de búsquedas en profundidad con límites crecientes hasta que se encuentra la meta 
o se agotan los límites.


aumenta la profundidad de 1 en 1 para llegar a la meta.
'''
